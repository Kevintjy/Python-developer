...
#通过super初始化父类，__init__()函数无self，若直接QtWidgets.QWidget.__init__(self)，括号里是有self的
        ...
        self.setWindowTitle(u'I love u')  # 仅仅设置窗体标题，不设置位置。
        ...
        self.setToolTip(u'I love you')#调用setToolTip()方法,该方法接受富文本格式的参数,css之类。
        ...
        self.window_pale.setBrush(self.backgroundRole(), QtGui.QBrush(QtGui.QPixmap("jiu.png")))#打开图片
    ...
    def showDialogNO(self):
        QtWidgets.QMessageBox.information(self, "不太行", "再考虑考虑呀~",QtWidgets.QMessageBox.Ok)
