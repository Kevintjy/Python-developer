...
class Person:
    ...
    def __eq__(self, other):
        return self.name == other.name and self.foods == other.foods

    def __str__(self):
        return str(self.name) + ' is a Person ' +\
               'who has eaten ' + str(len(self.foods)) + ' thing(s).'
...
class Student(Person):
    ...
    def __str__(self):
        return str(self.name) + ' is a Student ' + \
               'who has eaten ' + str(len(self.foods)) + ' thing(s).'
...
class Course:
    ...
    def __str__(self):
        student_list = []
        student_list.append(str(self.name) + ' Student log:')
...
if __name__ == '__main__':
    ...
    assert str(p) == "Sophia is a Person who has eaten 2 thing(s).", (
            "str(p) was expected to return\nSophia is a Person who has " +
            "eaten 2 thing(s).\nBut got\n{}\ninstead.").format(str(p))
    assert str(s) == "Sophia is a Student who has eaten 2 thing(s).", (
            "str(s) was expected to return\nSophia is a Student who has " +
