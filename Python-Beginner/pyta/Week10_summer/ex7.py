...
def get_largest_height_difference(tree: Union[BinaryTree, None]) -> int:
    ...
    # if tree is None:
    #     temp.append(0)
    # for node in get_all_node(tree):
    #     temp.append(helper(node))
    # return max(temp)
    ...
    return max(abs(get_height(tree.left) - get_height(tree.right)),
               get_largest_height_difference(tree.left), get_largest_height_difference(tree.right))


def get_all_node(tree):
    """
    get a list including all nodes in a tree
    """
    if tree is None:
        return []
    return [tree] + get_all_node(tree.left) + get_all_node(tree.right)


def helper(tree):
    """
    get the height difference for tree.left and tree.right
    """
    if tree.left or tree.right:
        return abs(get_height(tree.left) - get_height(tree.right))
    return 0
...
if __name__ == '__main__':
    ...
    print(t)
    print('============================')
    print(get_largest_height_difference(t))
